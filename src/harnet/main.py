...
def main():
    ...
    ts_pred_train = harnet.model.get_pred(model, scaler, ts[idx_range_train[0] - model.max_lag:idx_range_train[1], :])
    ts_pred_test = harnet.model.get_pred(model, scaler, ts[idx_range_test[0] - model.max_lag:idx_range_test[1], :])
